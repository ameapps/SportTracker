...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (root, chain, direction, index, changed = false, animation) {
    try {
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (root) {
    const ids = [];
    let outlet;
...
const Router = class {
  ...
  push(_x6) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (url, direction = 'forward', animation) {
      if (url.startsWith('.')) {
  ...
  safeWriteNavState(_x7, _x8, _x9, _x0, _x1) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (node, chain, direction, path, redirectFrom, index = 0, animation) {
  ...
  runGuards() {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (to = _this0.getPath(), from) {
      if (from === undefined) {
  ...
  writeNavState(_x10, _x11, _x12, _x13, _x14) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (node, chain, direction, path, redirectFrom, index = 0, animation) {
      ...
      const routeEvent = _this1.routeChangeEvent(path, redirectFrom);
