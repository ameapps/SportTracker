...
const Select = class {
  ...
  connectedCallback() {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this.mutationO = watchForOptions(_this.el, 'ion-select-option', /*#__PURE__*/(0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
        _this.updateOverlayOptions();
      }));
    })();
  }
