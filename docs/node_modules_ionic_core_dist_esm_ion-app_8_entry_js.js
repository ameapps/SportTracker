...
const App = class {
  ...
  componentDidLoad() {
    {
      rIC( /*#__PURE__*/(0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
        ...
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_status-tap-bdecfebf_js").then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-bdecfebf.js */ 44856)).then(module => module.startStatusTap());
        }
...
const Content = class {
  ...
  scrollToPoint(_x, _x2) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (x, y, duration = 0) {
...
const RouterOutlet = class {
  ...
  setRoot(component, params, opts) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      if (_this0.activeComponent === component) {
        return false;
      } // attach entering view to DOM


      const leavingEl = _this0.activeEl;
      const enteringEl = yield (0,_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_6__.a)(_this0.delegate, _this0.el, component, ['ion-page', 'ion-page-invisible'], params);
      _this0.activeComponent = component;
      _this0.activeEl = enteringEl; // commit animation

      yield _this0.commit(enteringEl, leavingEl, opts);
      yield (0,_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_6__.d)(_this0.delegate, leavingEl);
      return true;
    })();
  }
  ...
  transition(_x3, _x4) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (enteringEl, leavingEl, opts = {}) {
      if (leavingEl === enteringEl) {
        return false;
      } // emit nav will change event


      _this1.ionNavWillChange.emit();

      const {
        el,
        mode
      } = _this1;
      const animated = _this1.animated && _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('animated', true);
      const animationBuilder = opts.animationBuilder || _this1.animation || _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_2__.c.get('navAnimation');
        ...
        progressCallback: opts.progressAnimation ? ani => {
          ...
          if (ani !== undefined && !_this1.gestureOrAnimationInProgress) {
            ...
            ani.onFinish(() => {
              ...
              if (_this1.swipeHandler) {
                _this1.swipeHandler.onEnd(false);
              }
            }, {
              oneTimeCallback: true
            });
  ...
  lock() {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      const p = _this10.waitPromise;
      let resolve;
      _this10.waitPromise = new Promise(r => resolve = r);
