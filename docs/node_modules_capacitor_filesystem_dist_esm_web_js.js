...
class FilesystemWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  ...
  rmdir(options) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      const fullPath = _this0.getPath(directory, path);

      const entry = yield _this0.dbRequest('get', [fullPath]);
      if (entry === undefined) throw Error('Folder does not exist.');
      if (entry.type !== 'directory') throw Error('Requested path is not a directory');
      const readDirResult = yield _this0.readdir({
        path,
        directory
      });
      ...
      for (const entry of readDirResult.files) {
        ...
        const entryObj = yield _this0.stat({
          path: entryPath,
          directory
        });

        if (entryObj.type === 'file') {
          yield _this0.deleteFile({
            path: entryPath,
            directory
          });
        } else {
      ...
      yield _this0.dbRequest('delete', [fullPath]);
    })();
  }
  /**
  ...
  readdir(options) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      const path = _this1.getPath(options.directory, options.path);

      const entry = yield _this1.dbRequest('get', [path]);
      if (options.path !== '' && entry === undefined) throw Error('Folder does not exist.');
      const entries = yield _this1.dbIndexRequest('by_folder', 'getAllKeys', [IDBKeyRange.only(path)]);
  ...
  getUri(options) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      let entry = yield _this10.dbRequest('get', [path]);

      if (entry === undefined) {
        entry = yield _this10.dbRequest('get', [path + '/']);
      }
  ...
  rename(options) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      return _this12._copy(options, true);
    })();
  }
  /**
  ...
  copy(options) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      return _this13._copy(options, false);
    })();
  }
  ...
  _copy(_x) {
    ...
    return (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (options, doRename = false) {
      let {
        toDirectory
      } = options;
      const {
      ...
      const fromPath = _this14.getPath(fromDirectory, from);

      const toPath = _this14.getPath(toDirectory, to); // Test that the "to" and "from" locations are different
      ...
      try {
        ...
        if (toPathComponents.length > 0) {
          const toParentDirectory = yield _this14.stat({
            path: toPath,
            directory: toDirectory
          });
      ...
      const fromObj = yield _this14.stat({
        path: from,
        directory: fromDirectory
      }); // Set the mtime/ctime of the supplied path

      const updateTime = /*#__PURE__*/function () {
        var _ref = (0,C_Progetti_Ionic_IONIC_SportTracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (path, ctime, mtime) {
          const fullPath = _this14.getPath(toDirectory, path);

          const entry = yield _this14.dbRequest('get', [fullPath]);
          entry.ctime = ctime;
          entry.mtime = mtime;
          yield _this14.dbRequest('put', [entry]);
        });
      ...
      switch (fromObj.type) {
        ...
        case 'file':
          {
            // Read the file
            const file = yield _this14.readFile({
              path: from,
              directory: fromDirectory
            }); // Optionally remove the file

            if (doRename) {
              yield _this14.deleteFile({
                path: from,
                directory: fromDirectory
              });
        ...
        case 'directory':
          {
            ...
            const contents = (yield _this14.readdir({
              path: from,
              directory: fromDirectory
            })).files;
